...
var Prerendering = /** @class */ (function () {
                    ...
                    case 1:
                        ...
                        _loop_1 = function (route) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        this_1._currentRoute = route;
                                        routeUrl = this_1._getCurrentRouteUrl();
                                        coloredRouteUrl = cliColor.green(routeUrl);
                                        contentPath = this_1._getCurrentRouteFilePath();
    ...
    Prerendering.prototype._getCurrentRouteUrl = function () {
        return this.getBaseUrl() + this._currentRoute.getUrl();
    };
    Prerendering.prototype._getCurrentRouteFilePath = function () {
        var cleanUrl = this._currentRoute.getCleanUrl();
        return cleanUrl.endsWith(".html")
            ? this.getFolderPath() + cleanUrl
            : this.getFolderPath() + cleanUrl.replace(/^\/$/, "") + "/index.html";
    };
    Prerendering.prototype._getContentPath = function () { };
    return Prerendering;
}());
